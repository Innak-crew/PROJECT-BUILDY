                  ...
                  @forelse ( $pageData as $order)
                    <div class="invoice-{{substr($order->invoice()->first()->invoice_number, 5)}}" id="printableArea">
                      ...
                      <div class="row border-bottom border-warning border-5 align-items-center p-3 bg-light  shadow-sm">
                        ...
                        <div class="col-md-9 col-9  text-md-left">
                    ...
                    <p class="mt-4 mb-4">
                        ...
                        <div class="col-md-12">
                          <div class="text-start">
                            <address>
                              <h6>BILL TO,</h6>
                              <h6 class="ms-4 fw-bold invoice-customer">
                            ...
                            <table class="table table-hover">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>{{$item->catagories()->first()->name}} <br> {{$item->product()->first()->name}}</td>
                                  <td class="text-end">{{$item->quantity}}</td>
                                  <td class="text-end">{{$item->product()->first()->rate_per}}</td>
